...
internals.index = function (req, reply) {
  var credentials = {}, notification ={}, companyOwner={}, staffs={}, collectorDB= {}, collector_info={}, myBranches={}, branches={},
  calendars = {}, releases = {}, total_releases = {}, displayBranch = {};
  ...
  Async.series(
          ...
          $and: [
            ...
            {isCancel: false},
				...
				.exec((err, data) => {
					...
					staffs=data;
          if(staffs==null){
            return reply.view('staff/release/index.html', {
    ...
    function (callback) {
      reply.view('staff/release/index.html', {
        credentials: credentials,
        message: req.query.message,
        alertType: req.query.alertType,
        newAlertType: req.query.newAlertType,
...
internals.search_release = function (req, reply){
  var credentials = {}, notification ={}, companyOwner={}, staffs={}, collectorDB= {},
        ...
        Releases.findOne({
          $and: [
            ...
            return reply.redirect(
              "/staff/release?message=Error, Branch, Collector and Date is already exists!&alertType=error"
            );
          }
					return callback(null);
				});
            ...
            Total_releases.update(
              ...
              function (err, data) {
                if (err) {
                  ...
                  return reply.redirect("/staff/release?message=Successfully Created!&alertType=success");
                }
              },
            );
          }else{
          ...
          $and: [
            {_id: req.payload.total_releases_id},
				...
				.exec((err, data) => {
					...
					if(data==null){
            return reply.redirect("/staff/release?message=Error, Invalid input please try again!&alertType=error");
          }
          total_releases=data;
              ...
              Releases.remove(
                ...
                function (err, data) {
                  if (err) {
                    ...
                    return reply.redirect("/staff/release?message=Successfully Remove!&alertType=success");
                  }
                },
              );
            }
              ...
              Releases.update({
                ...
                function (err, updateReleases) {
                  if (err) {
                    ...
                    return reply.redirect("/staff/release?message=Successfully Updated!&alertType=success");
                  }
                },
              );
            }

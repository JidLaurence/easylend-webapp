...
var internals = {},
  ...
  internals.index = function (req, reply) {
    var credentials = {},  staffs={}, borrower_info={}, myBranches={}, branches={}, collectorsDB = {}, collectors_info = {},
    ...
    Async.series(
      [
        ...
        function(callback) {
          ...
          .exec((err, data) => {
            ...
            staffs=data;
            if(staffs==null){
              return reply.view('company/paid/index.html', {
      ...
      function (callback) {
        reply.view('company/paid/index.html', {
          credentials: credentials,
          message: req.query.message,
          alertType: req.query.alertType,
          newAlertType: req.query.newAlertType,
  ...
  internals.search_collect = function(req, reply){
    var credentials = {}, notification ={}, staffs={}, borrower_info={}, myBranches={}, branches={}, collectorsDB = {}, collectors_info = {}, get_customer = {},
